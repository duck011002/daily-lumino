  ...
  <view class="app-shell">
    ...
    <view class="bottom-nav safe-bottom">
      <view class="bottom-nav-item active">
        <image class="nav-icon-img" :src="getNavIcon('front', true)" mode="aspectFit" />
        <text>前厅</text>
      </view>
      <view class="bottom-nav-item" @tap="openBottom('ai')">
        <image class="nav-icon-img" :src="getNavIcon('ai', false)" mode="aspectFit" />
        <text>AI</text>
      </view>
      <view class="bottom-nav-item" @tap="openBottom('courtyard')">
        <image class="nav-icon-img" :src="getNavIcon('courtyard', false)" mode="aspectFit" />
        <text>内院</text>
      </view>
      <view class="bottom-nav-item" @tap="openBottom('account')">
